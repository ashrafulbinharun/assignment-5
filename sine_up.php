    ...
    if ( $_SERVER["REQUEST_METHOD"] === "POST" ) {
        ...
        if ( empty( $errorMessage ) ) {
            if ( registerUser( $role, $username, $email, $password ) ) {
                ...
                $errorMessage['register'] = "Invalid email or password";
            }
        }
    }
...
<head>
    ...
    <title>Assignment 5 | Sine Up</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2" style="margin: 120px auto">
                <?php if ( isset( $errorMessage['register'] ) ): ?>
                ...
                <div class="card shadow px-3">
                    <div class="card-body">
                        <h4 class="text-center mb-3">Sign Up Today!</h4>
